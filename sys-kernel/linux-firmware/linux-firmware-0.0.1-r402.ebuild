...
EAPI="7"
CROS_WORKON_COMMIT="9a30288c95298c0791dbcb327d30eae80ef8cb09"
CROS_WORKON_TREE="c6d44bcfae30af08a46a34199c14a354969434af"
...
install_iwlwifi() {
	...
	for x in "${IUSE_IWLWIFI[@]}"; do
		...
		iwlwifi-cc)    doins "${x}-a0-60.ucode" ;;
		iwlwifi-Qu-c0) doins "${x}-hr-b0-60.ucode" ;;
		iwlwifi-QuZ)
			case "${kernel}" in
			kernel-4_19) doins "${x}-a0-hr-b0-60.ucode" ;;
			kernel-5_4)  doins "${x}-a0-hr-b0-60.ucode" ;;
			kernel-upstream)  doins "${x}-a0-hr-b0-60.ucode" ;;
			*)
