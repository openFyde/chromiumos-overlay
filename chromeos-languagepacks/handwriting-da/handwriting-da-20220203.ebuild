...
DESCRIPTION="Handwriting da Language Pack for Chromium OS"
HOMEPAGE="https://www.chromium.org/chromium-os"

# Clients of Language Packs (Handwriting) need to update this path when new
# versions are available.
SRC_URI="gs://chromeos-localmirror/distfiles/languagepack-handwriting-da-${PV}.tar.xz"
...
src_install() {
	...
	# Install handwriting models for da.
