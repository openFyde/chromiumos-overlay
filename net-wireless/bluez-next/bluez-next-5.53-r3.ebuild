...
EAPI="7"
CROS_WORKON_COMMIT="1524499483a3678951c0e3059b158836398c4e9b"
CROS_WORKON_TREE="40ff8f2617391a5d10ed1e444d58815cfa425eaa"
...
src_install() {
	...
	dobin tools/btmgmt
	# TODO(b/150951215): hciconfig and hcitool are deprecated in 5.53.
	# Figure out if still needed by Chrome OS.
	...
	dolib.so lib/.libs/libbluetooth.so.3.19.1
	...
	# TODO(b/150951215): Chrome OS uses main_common.conf and split the
	# board-specific confs.
	# doins "${S}"/src/main_common.conf
	doins "${S}"/src/main.conf
