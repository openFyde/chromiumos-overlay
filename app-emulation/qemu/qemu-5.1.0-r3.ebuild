...
if [[ ${PV} = *9999* ]]; then
	...
	SRC_URI="!binary? ( https://download.qemu.org/${P}.tar.xz ) binary? ( gs://chromeos-prebuilt/host/amd64/amd64-host/chroot-2021.04.07.021444/packages/app-emulation/qemu-5.1.0-r2.tbz2 )"
	KEYWORDS="*"
fi
...
IUSE="accessibility +binary +aio alsa bzip2 capstone +caps +curl debug doc
