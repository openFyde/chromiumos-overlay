...
DESCRIPTION="Handwriting fil Language Pack for Chromium OS"

# Clients of Language Packs (Handwriting) need to update this path when new
# versions are available.
SRC_URI="gs://chromeos-localmirror/distfiles/languagepack-handwriting-fil-${PV}.tar.xz"
...
src_install() {
	...
	# Install handwriting models for fil.
