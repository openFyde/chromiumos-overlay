...
[[ "${PV}" = *_pre* ]] || \
KEYWORDS="*"
IUSE="+asm bindist cros_host elibc_musl pita rfc3779 sctp cpu_flags_x86_sse2 sslv3 static-libs test tls-heartbeat vanilla zlib"
...
RDEPEND+="
	=dev-libs/openssl-1.0.2u-r5:legacy
	!<dev-libs/openssl-1.0.2u-r5:legacy
"
DEPEND="${RDEPEND}"
BDEPEND="
