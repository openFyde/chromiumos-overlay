...
EAPI="7"
CROS_WORKON_COMMIT="6a7ff1391d87a3e00a64a7ca30b4e85d010c960c"
CROS_WORKON_TREE="652b07fa10ab539e2cb86f727f3146bf299bf2b5"
...
install_iwlwifi() {
	...
	for x in "${IUSE_IWLWIFI[@]}"; do
		...
		iwlwifi-cc)    doins "${x}-a0-62.ucode" ;;
		iwlwifi-QuZ)
			case "${kernel}" in
			kernel-4_19) doins "${x}-a0-hr-b0-62.ucode" ;;
			kernel-5_4)  doins "${x}-a0-hr-b0-62.ucode" ;;
