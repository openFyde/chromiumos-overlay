...
EAPI="7"
CROS_WORKON_COMMIT="0eff9ea1316f5872e55ae23cfef85fa6aa90812d"
CROS_WORKON_TREE="da83ce1fab30ce6524b0e2ee105a9401da9a2264"
...
install_iwlwifi() {
	...
	for x in "${IUSE_IWLWIFI[@]}"; do
		...
		iwlwifi-cc)    doins "${x}-a0-57.ucode" ;;
		iwlwifi-Qu-c0) doins "${x}-hr-b0-57.ucode" ;;
		iwlwifi-QuZ)
			case "${kernel}" in
			kernel-4_19) doins "${x}-a0-hr-b0-57.ucode" ;;
			kernel-5_4)  doins "${x}-a0-hr-b0-57.ucode" ;;
			kernel-upstream)  doins "${x}-a0-hr-b0-57.ucode" ;;
			*)
